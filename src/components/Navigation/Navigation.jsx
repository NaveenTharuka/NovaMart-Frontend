    ...
    return (
        <nav className={styles.nav}>
            <ul className={`${styles.navList} ${mobile ? styles.mobile : ""}`}>
                ...
                <li
                    className={`${styles.dropdownItem} ${mobile ? styles.mobileDropdownItem : ""}`}
                    onMouseEnter={() => !mobile && setOpenDropdown(true)}
                    onMouseLeave={() => !mobile && setOpenDropdown(false)}
                >
                    <button
                        type="button"
                        className={`${styles.navLink} ${styles.dropdownTitle}`}
                        onClick={() => mobile && setOpenDropdown(p => !p)}
                    >
                        Products
                    </button>
            ...
            `}
                ...
                <li className={styles.navItem}>
                    <Link to="/contact" onClick={toggleMenu} className={styles.navLink}>
                        Contact
                    </Link>
                </li>
            </ul>
