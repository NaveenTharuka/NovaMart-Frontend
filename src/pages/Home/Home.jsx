...
import Beams from "@/components/common/Background/Background";
...
function Home() {
    ...
    const heroOpacity = Math.max(0, 1 - scrollY / (heroHeight * 0.5));
    ...
    return (
        <div className={styles['home-page']}>
            ...
            <section className={styles['hero-section']} ref={heroRef}>
                ...
                <div className={styles['hero-content']} style={{ opacity: heroOpacity }}>
